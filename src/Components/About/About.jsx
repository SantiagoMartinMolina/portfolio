...
const About = () => {
    return (
        <StyledAbout>
            ...
            <p className='text'>Hola! Soy desarrollador en javascript y estudiante de ingeniería en sistemas. Me apasiona la tecnología, el desarrollo frontend y backend. Comencé de forma autodidacta y luego cursé un bootcamp de 700 hs de estudio donde aprendí principalmente Javascript, React, Node, Express y SQL mediante la creación de diversos proyectos.</p>
